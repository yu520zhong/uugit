  ...
  firstScriptTag.parentNode.insertBefore(tag, firstScriptTag)
	...
	function buildfigure(mediafigure, curmedia, totalmedia){
		...
		if (mediafigure[1] || totalmedia > 1){
			figurehtml += '<figcaption class="thecaption"><div class="captioninner">'  + (mediafigure[1] || "") + '</div></figcaption>\n'
		}
		figurehtml += '</figure>'
		return figurehtml
	}
	...
	function buildvideocontainer(mediafigure, curmedia, totalmedia){
		...
		if (mediafigure[1] || totalmedia > 1){
			videohtml += '<div class="thecaption"><div class="captioninner">'  + (mediafigure[1] || "") + '</div></div>\n'
		}
		videohtml += '</div>'
		return videohtml
	}
